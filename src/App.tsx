...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div>
          <a href="https://abejorro-digital.rf.gd" class="back-home-link" title="Volver a la página principal"> <img src="https://abejorro-digital.rf.gd/wp-content/uploads/2026/03/LOGOTIPO-ABEJORRO-DIGITAL-amarillo.png" alt="Abejorro Digital Logo">
